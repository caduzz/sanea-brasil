    ...
    <section id="tema" className="w-full flex justify-center p-10">
      <div className="w-full max-w-[1250px] flex flex-col md:flex-row items-center justify-center">
        <div className="md:w-[50%] w-full flex flex-col">
          <div className="grid grid-cols-2 grid-rows-2 md:grid-rows-4 gap-8">
            ...
            <div className="w-full col-start-1 row-start-2 md:row-span-2 md:col-start-1 md:row-start-3 rounded-2xl overflow-hidden flex items-center justify-center">
            ...
            <div className="w-full col-start-2 row-start-1 overflow-hidden">
              <div className="w-full h-full md:h-40 bg-[#235D89] rounded-2xl flex flex-col items-center justify-center">
                <p className="text-white md:text-3xl">Dias</p>
                <h2 className="text-white md:text-3xl font-bold">29, 30 e 31</h2>
              </div>
            </div>
            <div className="w-full md:row-span-3 md:col-start-2 row-start-2 rounded-2xl overflow-hidden">
