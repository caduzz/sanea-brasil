    ...
    <section id="tema" className="w-full flex justify-center p-10">
      <div className="w-full max-w-[1250px] flex flex-col md:flex-row items-center justify-center">
        <div className="md:w-[50%] w-full flex flex-col">
          <div className="grid md:grid-cols-2 md:grid-rows-4 gap-8">
            <div className="w-full h-32 md:h-full row-span-2 relative">
              <div className="w-full h-full rounded-2xl absolute border-[1px] border-[#235D89] z-1"></div>
              <img
                className="w-32 h-32 md:w-full md:h-full object-cover absolute transform -translate-x-4 -translate-y-4 rounded-2xl"
                src="./theme.png"
              />
            </div>
            <div className="w-full h-32 md:h-full row-span-2 col-start-1 row-start-3 rounded-2xl overflow-hidden flex items-center justify-center">
              <img
            ...
            <div className="w-full col-start-2 row-start-1 overflow-hidden">
              <div className="w-full h-32 md:h-40 bg-[#235D89] rounded-2xl flex flex-col items-center justify-center">
                <p className="text-white text-3xl">Dias</p>
                <h2 className="text-white text-3xl font-bold">29, 30 e 31</h2>
              </div>
            </div>
            <div className="w-full h-32 md:h-full row-span-3 col-start-2 row-start-2 rounded-2xl overflow-hidden">
              <img
        ...
        <div className="md:w-[60%] w-full h-full flex flex-col gap-4 md:ml-20">
          ...
          <div className="w-full text-md text-[#235D89] flex flex-row gap-8">
